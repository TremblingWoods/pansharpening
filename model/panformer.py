...
# from modules1 import conv3x3, SwinModule
...
class Net(nn.Module):
    def __init__(self,num_channels=4,channels=None,base_filter=None,args=None,n_feats=64, n_heads=4, head_dim=16, win_size=4,
