...
class Crossmodality(nn.Module):
    def __init__(self):
        ...
        # 在构造函数中定义神经网络的层次结构
        num_channels = 32
        self.conv_1 = nn.Conv2d(num_channels, num_channels*2, kernel_size=1, padding=0, bias=True)
        self.conpan_1 = nn.Conv2d(num_channels, num_channels * 2, kernel_size=1, padding=0, bias=True)
        self.act_1 = nn.GELU()
        self.conv_2 = nn.Conv2d(num_channels*4, num_channels, kernel_size=1, padding=0, bias=True)
        self.act_2 = nn.GELU()
