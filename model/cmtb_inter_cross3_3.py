...
class Net(nn.Module):
    def __init__(self, num_channels=4,channels=None,base_filter=None,args=None):
        ...
        self.CMTB2 = AttentionTransformerBlock(dim=channels*2, out_dim=channels*2, num_heads=8, window_size=8,
                                                    ...
                                                    deformable=False, learnable=True, restart_regression=None,
                                                    img_size=(64, 64))
        self.patition2 = PatchMerging(channels*2,channels*4)
        self.patition2_2 = PatchMerging(channels*2, channels*4)

        self.CMTB3 = AttentionTransformerBlock(dim=channels*4, out_dim=channels*4, num_heads=8, window_size=8,
                                                    attn_window_size=None, shift_size=0, mlp_ratio=2., qkv_bias=True,
        ...
        self.fuse = nn.Conv2d(channels //2, channels//2, kernel_size=1, padding=0, bias=True)
        self.relu = nn.LeakyReLU()
        self.conv_out = Refine(channels//2, 4)
