...
class AttentionTransformerBlock(nn.Module):
    ...
    def forward(self, pan, lms):
        ...
        attn_out = self.attn(self.norm1_pan(pan))
...
class Net(nn.Module):
    def __init__(self, num_channels=4,channels=None,base_filter=None,args=None):
        ...
        self.CMTB1 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                    ...
                                                    img_size=(128, 128))
        self.CMTB1_2 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                      attn_window_size=None, shift_size=0, mlp_ratio=4., qkv_bias=True,
                                                      qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.CMTB2 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                    ...
                                                    deformable=False, learnable=True, restart_regression=None,
                                                    img_size=(128, 128))
        self.CMTB2_2 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                    attn_window_size=None, shift_size=0, mlp_ratio=4., qkv_bias=True,
                                                    qk_scale=None, drop=0., attn_drop=0.,
                                                    drop_path=0., act_layer=nn.GELU, norm_layer=LayerNorm, stride=False,
                                                    relative_pos_embedding=False, deform_relative_pos_embedding=False,
        ...
        self.CMTB3 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                    ...
                                                    deformable=False, learnable=True, restart_regression=None,
                                                    img_size=(128, 128))
        self.CMTB3_2 = AttentionTransformerBlock(dim=channels, out_dim=channels, num_heads=8, window_size=8,
                                                    attn_window_size=None, shift_size=0, mlp_ratio=4., qkv_bias=True,
                                                    qk_scale=None, drop=0., attn_drop=0.,
                                                    drop_path=0., act_layer=nn.GELU, norm_layer=LayerNorm, stride=False,
                                                    relative_pos_embedding=False, deform_relative_pos_embedding=False,
